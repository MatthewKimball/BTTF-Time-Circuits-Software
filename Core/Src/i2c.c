...
void HAL_I2C_MspDeInit(I2C_HandleTypeDef* i2cHandle)
{
  ...
  /* USER CODE END I2C2_MspDeInit 0 */
    ...
    PB11     ------> I2C2_SDA
    */
    HAL_GPIO_DeInit(EXT_RTC_SCL_GPIO_Port, EXT_RTC_SCL_Pin);

    HAL_GPIO_DeInit(EXT_RTC_SDA_GPIO_Port, EXT_RTC_SDA_Pin);
  ...
  /* USER CODE END I2C3_MspDeInit 0 */
    ...
    PA8     ------> I2C3_SCL
    */
    HAL_GPIO_DeInit(TC_DISPLAY_SDA_GPIO_Port, TC_DISPLAY_SDA_Pin);

    HAL_GPIO_DeInit(TC_DISPLAY_SCL_GPIO_Port, TC_DISPLAY_SCL_Pin);
