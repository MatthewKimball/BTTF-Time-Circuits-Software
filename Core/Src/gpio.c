...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : KEYPAD_COL_2_Pin KEYPAD_COL_1_Pin SD_CS_Pin DIAGNOSTIC_RGB_LED_Pin */
  ...
  /*Configure GPIO pins : SD_CD_Pin KEYPAD_ENTER_Pin GLITCH_SWITCH_Pin EXT_RTC_INT_Pin */
  ...
  /*Configure GPIO pins : CAN_ID_SWITCH_1_Pin CAN_ID_SWITCH_2_Pin CAN_ID_SWITCH_3_Pin MUTE_SWITCH_Pin */
  GPIO_InitStruct.Pin = CAN_ID_SWITCH_1_Pin|CAN_ID_SWITCH_2_Pin|CAN_ID_SWITCH_3_Pin|MUTE_SWITCH_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOC, &GPIO_InitStruct);

  /*Configure GPIO pin : TIME_TRAVEL_SIM_Pin */
  ...
  /*Configure GPIO pin : EXT_RTC_RST_Pin */
