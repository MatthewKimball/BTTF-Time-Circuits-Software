...
********************************************************************************
    ...
    File info:
        ...
        Project File: DS301_Time_Circuit_Profile.xdd
        File Version: 1

        Created:      23/11/2020 13:00:00
        Created By:   Matthew Kimball
        Modified:     10/08/2025 15:44:18
        Modified By:  

    Device Info:
        Vendor Name:  Kimball Enterprises
        Vendor ID:    
        Product Name: Time Circuits
        Product ID:   TC

        Description:  Delorean Time circuit
*******************************************************************************/
...
typedef struct {
    ...
    uint8_t x2100_buttonsState;
    uint8_t x2101_timeCircuitsState;
    uint8_t x2102_requestedTimeCircuitsState;
    uint8_t x2200_functionControl;
    struct {
        uint8_t highestSub_indexSupported;
        uint32_t glitchPeriod;
        uint8_t IMU_MotionDetectionThreshold;
        uint8_t IMU_MotionDetectionDuration;
        uint8_t settingBits;
...
#define OD_ENTRY_H2101 &OD->list[35]
#define OD_ENTRY_H2102 &OD->list[36]
#define OD_ENTRY_H2200 &OD->list[37]
...
#define OD_ENTRY_H2000_destinationTime &OD->list[31]
#define OD_ENTRY_H2001_presentTime &OD->list[32]
#define OD_ENTRY_H2002_lastDepartedTime &OD->list[33]
#define OD_ENTRY_H2100_buttonsState &OD->list[34]
#define OD_ENTRY_H2101_timeCircuitsState &OD->list[35]
#define OD_ENTRY_H2102_requestedTimeCircuitsState &OD->list[36]
#define OD_ENTRY_H2200_functionControl &OD->list[37]
#define OD_ENTRY_H2300_settingParameters &OD->list[38]
